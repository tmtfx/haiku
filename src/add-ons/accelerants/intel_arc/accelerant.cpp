...
//static uint32 overlay_plane_register(uint32 base, int8 pipe); rimasto static in overlay.cpp
...
//static status_t set_sink_power(uint8 ddiPort, uint8 value); rimasto static in dpms
