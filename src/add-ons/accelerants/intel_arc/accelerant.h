...
*/
#define INTEL_ARC_DG2_DPLL0_ENABLE				0x46010 // come per tiger lake?
#define INTEL_ARC_DG2_DPLL1_ENABLE				0x46014
#define INTEL_ARC_DG2_DPLL4_ENABLE				0x46018
#define INTEL_ARC_DG2_DPLL_ENABLE				(1U << 31)
#define INTEL_ARC_DG2_DPLL_LOCK					(1U << 30)
/*
...
#define INTEL_ARC_PLANE_BUF_CFG_1_A   0x7027C  // DBUF Plane Primario Pipe A
#define INTEL_ARC_CUR_BUF_CFG_A       0x70078
