...
#define SM750_DISP_PANEL_VIDEO_ALPHA_SCALE			0x00080098
#define SM750_DISP_PANEL_VIDEO_ALPHA_INIT_SCALE		0x0008009C
#define SM750_DISP_PANEL_VIDEO_ALPHA_CHROMA_KEY		0x000800A0
...
#define GPIO_BIT_SDA              (1 << 15) // Pin 31 on _HIGH
#define GPIO_BIT_SCL              (1 << 14) // Pin 30 on _HIGH
#define SM750_GPIO_DATA_LOW		0x010000
#define SM750_GPIO_DATA			0x010000
#define SM750_GPIO_DATA_HIGH	0x010004
#define SM750_GPIO_DIR_LOW		0x010008
#define SM750_GPIO_DIRECTION	0x010008
#define SM750_GPIO_DIR_HIGH		0x01000C
